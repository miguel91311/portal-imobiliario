      ...
      <div className="luxury-container py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="text-white/70 text-body leading-relaxed max-w-md mb-4">
              ...
              Propriedades selecionadas em Portugal e Angola com curadoria algorítmica e transparência fiscal.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-body text-white/80">
              <li><span className="hover:text-white transition-colors cursor-default">Lisboa</span></li>
              <li><span className="hover:text-white transition-colors cursor-default">Porto</span></li>
              <li><span className="hover:text-white transition-colors cursor-default">Cascais</span></li>
              <li><span className="hover:text-white transition-colors cursor-default">Luanda</span></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-6 text-caption text-white/50">
            <span className="flex items-center gap-1.5"><Globe className="w-3.5 h-3.5" /> Portugal</span>
            <span className="flex items-center gap-1.5"><Shield className="w-3.5 h-3.5" /> SSL · GDPR</span>
          </div>
